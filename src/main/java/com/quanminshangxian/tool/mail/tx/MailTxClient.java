...
public class MailTxClient {
    ...
    public static SendResponse sendMail(
        ...
        try {
            ...
            // 3. 创建一封邮件
            MimeMessage message = createMimeMessage(senderEmailAccount, senderEmailPassword, senderNickName, session, receiveMail, subject, content,
            ...
            emailResponse.setMsg("发送失败，腾讯企业邮箱服务连接失败");
            return emailResponse;
        }
    }
